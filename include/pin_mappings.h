...
constexpr int16_t PIQUET_IDLE_TARGET_ROTATION = 0;
constexpr int16_t PIQUET_RELOADING_TARGET_ROTATION = 140;
...
constexpr int16_t PINCE_FLIP_MIN_ANGLE = 0;
constexpr int16_t PINCE_FLIP_IDLE_ANGLE = 80;
constexpr int16_t PINCE_FLIP_MAX_ANGLE = 180;
...
constexpr int16_t PINCE_DOIGT_IDLE_ANGLE = 45;
constexpr int16_t PINCE_DOIGT_MAX_ANGLE = 180;
