...
#define PINCE_POIGNET_MIN_ANGLE 0
#define PINCE_POIGNET_IDLE_ANGLE 90
#define PINCE_POIGNET_MAX_ANGLE 180
#define PINCE_POIGNET_DEBOUNCE_TIME 250
 ...
 */
#define CONTROLLER_PINCE_UP_MOVEMENT BUTTON::ARROW_UP
#define CONTROLLER_PINCE_DOWN_MOVEMENT BUTTON::ARROW_DOWN
#define CONTROLLER_PINCE_LEFT_MOVEMENT BUTTON::ARROW_LEFT
#define CONTROLLER_PINCE_RIGHT_MOVEMENT BUTTON::ARROW_RIGHT
#define CONTROLLER_PINCE_POIGNET_LEFT ANALOG::GACHETTE_L
#define CONTROLLER_PINCE_POIGNET_RIGHT ANALOG::GACHETTE_R
#define CONTROLLER_PINCE_MANUAL_FLIP BUTTON::START
#define CONTROLLER_PINCE_DOIGTS BUTTON::L1
#define CONTROLLER_PIQUET_TOGGLE_ROTATOR BUTTON::COLORS_UP
#define CONTROLLER_PIQUET_TOGGLE_STOPPER BUTTON::COLORS_RIGHT

#define SHOOT_KEY BUTTON::R1
#define RELOAD_KEY BUTTON::COLORS_LEFT
